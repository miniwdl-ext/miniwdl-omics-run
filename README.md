...
- To use [VPC networking](https://docs.aws.amazon.com/omics/latest/dev/workflows-vpc-networking.html), pass the name of an existing HealthOmics VPC configuration with `--vpc-config {NAME}`.
